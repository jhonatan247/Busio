...
{
    #region Class
    public class Nota_Cotizacion_Salida
    {
        #region Atributos
        ...
        public Nota_Cotizacion_Salida()
        {
        }
        public Nota_Cotizacion_Salida(long pid, long pid_usuario, string pprimer_nombre, string psegundo_nombre, string pprimer_apellido, string psegundo_apellido,

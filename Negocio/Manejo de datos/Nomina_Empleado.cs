...
namespace Negocio.Manejo_de_datos
{
    ...
    public class Nomina_Empleado
    {
        ...
        public long Id_Nomina_Empleado { get; set; }
        public long Id_Trabajador { get; set; }
        public double Sueldo_Base { get; set; }
        public double Valor_Hora_Extra { get; set; }
        #endregion
        ...
        public Nomina_Empleado(long pid, long pid_usuario, string pprimer_nombre, string psegundo_nombre, string pprimer_apellido, string psegundo_apellido,

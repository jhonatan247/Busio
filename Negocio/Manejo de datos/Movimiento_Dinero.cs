...
namespace Negocio.Manejo_de_datos
{
    ...
    public class Movimiento_Dinero
    {
        ...
        public bool Tipo_Movimiento { get; set; }
        public double Cantidad_Movida { get; set; }
        ...
        public Movimiento_Dinero(long pid, long pid_usuario, string pprimer_nombre, string psegundo_nombre, string pprimer_apellido, string psegundo_apellido,

...
namespace Negocio.Manejo_de_datos
{
    ...
    public class Marca
    {
        ...
        public Marca(long pId, string pNombre, string pDescripcion, bool pEstado)
        {
            Id = pId;
            Nombre = pNombre;
        ...
        public Marca(string pNombre, string pDescripcion)
        {
            Nombre = pNombre;
            Descripcion = pDescripcion;
        }
        public Marca(long pId, bool pEstado)
        {
            Id = pId;
            Estado = pEstado;
        }
        public Marca(bool pEstado)
        {
            Estado = pEstado;
        }
        #endregion
        ...
        {
            Comando = new SqlCommand();
            Comando.CommandText = "Update_Marca";
        ...
        {
            Comando = new SqlCommand();
            Comando.CommandText = "UpdateAll_Estado_Marca";
        ...
        public List<string> SelectAll()
        {
            ...
            Comando = new SqlCommand();
            Comando.CommandText = "SelectAll_Nombre_Marca";
        ...
        {
            Comando = new SqlCommand();
            Comando.CommandText = "SelectId_Nombre_Marca";
        ...
        {
            Comando = new SqlCommand();
            Comando.CommandText = "Like_Marca";
        ...
        {
            Comando = new SqlCommand();
            Comando.CommandText = "Like_Marca_Of";
        ...
        {
            Comando = new SqlCommand();
            Comando.CommandText = "Delete_Marca";
        ...
        {
            Comando = new SqlCommand();
            Comando.CommandText = "DeleteAll_Of_Marca";

...
namespace Negocio.Manejo_de_datos
{
    ...
    public class Nota_Promocion 
    {
        ...
        public Nota_Promocion(long pid, long pid_usuario, string pprimer_nombre, string psegundo_nombre, string pprimer_apellido, string psegundo_apellido,

...
{
    #region Class
    public class Nota_Movimiento_Dinero
    {
        #region Atributos
        ...
        public long Id_Movimiento_Dinero { get; set; }
        public string Nota { get; set; }
        
        #endregion

        #region Constructores
        public Nota_Movimiento_Dinero()
        {
        }
        public Nota_Movimiento_Dinero(long pid, long pid_usuario, string pprimer_nombre, string psegundo_nombre, string pprimer_apellido, string psegundo_apellido,

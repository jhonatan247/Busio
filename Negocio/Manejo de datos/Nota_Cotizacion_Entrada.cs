...
{
    #region Class
    public class Nota_Cotizacion_Entrada
    {
        #region Atributos
        ...
        public Nota_Cotizacion_Entrada()
        {
        }
        public Nota_Cotizacion_Entrada(long pid, long pid_usuario, string pprimer_nombre, string psegundo_nombre, string pprimer_apellido, string psegundo_apellido,
